...
Изучив структуру регулярного выражения, мне не удалось найти ничего интересного. 
В следующем пункте описано получение расширенного регулярного выражения, которое могло бы стать основой для ПКА, 
однако там lookahead просто проверяет на то, состоит ли язык только из a и b. Больше никаких идей мне найти не удалось.
А так как НКА - частный случай ПКА, то его и можно считать ответом.
...
$ (\tau?)^+$, но это не упрощает выражение, а скорее наоборот делает его менее читаемым.
